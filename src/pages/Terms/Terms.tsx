...
const Terms: Component = () => {
  return (
    <div class="flex w-full max-h-screen">
      ...
      <main
        aria-live="polite"
        class="flex flex-grow justify-center px-ld-24 py-ld-40 min-h-screen sm:px-ld-40 lg:min-h-fit overflow-auto"
      >
        <div class="container flex-grow mx-auto relative max-w-2xl flex flex-col">
          ...
          <div class="mb-auto pb-24">
            ...
            <ld-typo class="block mb-ld-32">
              What follows below is a pretty long lorem ipsum. Its purpose is to
              give you an impression of what a page containing a text desert
              would feel like.
            </ld-typo>

            <ld-typo variant="h4" tag="h2" class="mb-4">
